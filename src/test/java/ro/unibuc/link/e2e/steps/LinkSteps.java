...
public class LinkSteps {
    ...
    public void the_client_issues_DELETE() {
        executeDelete("http://localhost:8089/short-link");
    }
    ...
    public void the_client_issues_POST_url() {
        executePostUrl("http://localhost:8089/short-link/set");
    }
